...
function ProfileLink() {
  ...
  return (
    <>
      <Tooltip hasArrow label={'Profile'} placement='right' marginLeft={1} 
        openDelay={500} display={{base: 'block', md: 'none'}}
      >
        <Link display={'flex'} to={`/${authUser?.userName}`} as={RouterLink} alignItems={'center'} gap={4} _hover={{backgroundColor: 'whiteAlpha.400'}} 
